        ...
        for y in range(self.height - 2, -1, -1):
                for x in range(self.width):
                    if g[y, x] == Material.SAND:
                        if y + 1 < self.height and g[y + 1, x] == Material.EMPTY:
                            self._types[y, x] = Material.EMPTY
                            self._types[y + 1, x] = Material.SAND
                        elif y + 1 < self.height and x - 1 >= 0 and x + 1 < self.width and g[y + 1, x - 1] == Material.EMPTY and g[y + 1, x + 1] == Material.EMPTY:
                            if _rng.choice([1, -1]) == 1:
                                self._types[y, x] = Material.EMPTY
                                self._types[y + 1, x + 1] = Material.SAND
                            else:
                                self._types[y, x] = Material.EMPTY
                                self._types[y + 1, x - 1] = Material.SAND
                        elif y + 1 < self.height and x - 1 >= 0 and g[y + 1, x - 1] == Material.EMPTY:
                            self._types[y, x] = Material.EMPTY
                            self._types[y + 1, x - 1] = Material.SAND
                        elif y + 1 < self.height and x + 1 < self.width and g[y + 1, x + 1] == Material.EMPTY:
                            self._types[y, x] = Material.EMPTY
                            self._types[y + 1, x + 1] = Material.SAND
                            
        for y in range(self.height - 2, -1, -1):
                for x in range(self.width):
                    if g[y, x] == Material.WATER:
                        if y + 1 < self.height and g[y + 1, x] == Material.EMPTY:
                            self._types[y, x] = Material.EMPTY
                            ...
                            if _rng.choice([1, -1]) == 1:
                                self._types[y, x] = Material.EMPTY
                                self._types[y + 1, x + 1] = Material.WATER
                            else:
                                self._types[y, x] = Material.EMPTY
                                self._types[y + 1, x - 1] = Material.WATER
                        elif y + 1 < self.height and x - 1 >= 0 and g[y + 1, x - 1] == Material.EMPTY:
                            ...
                            a = _rng.choice([1, -1])
                            if 0 <= x + a < self.width and g[y, x + a] == Material.EMPTY:
                                self._types[y, x] = Material.EMPTY
                                self._types[y, x + a] = Material.WATER
